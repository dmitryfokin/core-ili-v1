module.exports = {
  iliTypesItem: [
    {id: 'f8cd8bf9-8263-40e0-9460-c0951aa648ad', key: 'Folder', description: 'Folder'},
    {id: 'b6e327aa-de3d-4453-a5a4-3e399c596880', key: 'WorkSpace', description: 'WorkSpace'},
    {id: 'a2de225b-91c1-4658-85c5-ee899146b497', key: 'Task', description: 'Task'},
  ],
  iliTypesLink: [
    {id: '9dab6ac9-9421-4deb-97ab-4eaa433378cc', key: 'AnyItems', description: 'AnyItems'},
    {id: '56fe0b15-1844-4d43-9567-6553804463a6', key: 'WorkSpace', description: 'WorkSpace'},
    {id: 'a86fe40e-b6e4-4f2b-b17d-a5f2b4b15134', key: 'SubTasks', description: 'SubTasks'},
  ],
  clearDBPG: [
    'prefix_ili_items',
    'prefix_ili_links',
